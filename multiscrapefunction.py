...
if len(sys.argv) == 3:
    ...
    usernameB = input('Enter second username: ')
else:
    print("This script currently only supports exactly two usernames. Run the script without arguments and you will be prompted to enter them.")
    quit()
